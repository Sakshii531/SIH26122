...
async def create_review(payload: ReviewItemCreate) -> ReviewItemResponse:
    """Create a new human review item for an AI extraction/matching result."""
...
async def get_review(review_id: UUID) -> ReviewItemResponse:
...
async def submit_review_decision(
    ...
    """Submit a reviewer decision (APPROVED, REJECTED, MODIFIED) on a pending review item."""
