...
async def create_progress(payload: ProgressFromReviewCreate) -> ProgressEventResponse:
    """Create a validated ProgressEvent from an APPROVED or MODIFIED human review."""
...
async def get_progress(progress_id: UUID) -> ProgressEventResponse:
